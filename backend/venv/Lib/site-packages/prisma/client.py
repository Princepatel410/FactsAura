...
SCHEMA_PATH = Path('/Users/princepatel/factzaura/FactZAura/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/princepatel/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    incident: 'actions.IncidentActions[models.Incident]'
    post: 'actions.PostActions[models.Post]'
    comment: 'actions.CommentActions[models.Comment]'
    demostate: 'actions.DemoStateActions[models.DemoState]'
    ...
    def __init__(
        ...
        *,
        ...
        self.incident = actions.IncidentActions[models.Incident](self, models.Incident)
        ...
        self.demostate = actions.DemoStateActions[models.DemoState](self, models.DemoState)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/princepatel/factzaura/FactZAura/backend/prisma/schema.prisma',
        }
...
class Batch:
    incident: 'IncidentBatchActions'
    post: 'PostBatchActions'
    comment: 'CommentBatchActions'
    demostate: 'DemoStateBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.incident = IncidentBatchActions(self)
        self.post = PostBatchActions(self)
        self.comment = CommentBatchActions(self)
        self.demostate = DemoStateBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class DemoStateBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.DemoStateCreateInput,
        include: Optional[types.DemoStateInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.DemoState,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.DemoStateCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.DemoStateWhereUniqueInput,
        include: Optional[types.DemoStateInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.DemoStateUpdateInput,
        where: types.DemoStateWhereUniqueInput,
        include: Optional[types.DemoStateInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.DemoStateWhereUniqueInput,
        data: types.DemoStateUpsertInput,
        include: Optional[types.DemoStateInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.DemoStateUpdateManyMutationInput,
        where: types.DemoStateWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.DemoState,
    ...
    def delete_many(
        self,
        where: Optional[types.DemoStateWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.DemoState,
