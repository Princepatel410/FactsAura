...
class BaseDemoState(_PrismaModel):
    __prisma_model__: ClassVar[Literal['DemoState']] = 'DemoState'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.DemoStateActions[_PrismaModelT]':
        from .client import get_client

        return actions.DemoStateActions[_PrismaModelT](client or get_client(), cls)
